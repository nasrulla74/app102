...
export const getBannerQuery = groq`*[_type == "banner"]`;
export const getProducstQuery = groq`*[_type == "product"]`;

export const getProductQuery = groq`*[_type == "product" && slug.current == $slug][0]`;
